...
// 	string create = "cReAte taBLe lol   ({key} haha : string[2])";
// 	string insert1 = "insert () to lol";
...
// 	string select2 = "select autoincrCol from lol where true";
...
// 	// insertPost1 = db.execute(insert1);
// 	// if(!insertPost1.isOk()){cout << insertPost1.getError() << endl;}
...
// 	// 	cout << elem.getInt("autoincrCol") << endl;
